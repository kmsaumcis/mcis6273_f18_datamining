...
|**_Clustering_**| Uncovering patterns in data that are typically not known or previously categorized.  For example, determining the topics within a set of unknown tweets; or finding the usage patterns of a particular application.  |
